...
<head>
 ...
 <?php
      ...
      for ($i = 1; $i <= 12; $i++) {
		  if ($i<10){
      $sql= "SELECT  valor FROM dre WHERE mesano ='$ano-0$i' and descricao='DESPESAS VARIAVEIS DE VENDA'";
   }
   
      else{
  $sql= "SELECT  valor FROM dre WHERE mesano ='$ano-$i' and descricao='DESPESAS VARIAVEIS DE VENDA'";
    ...
    window.onload = function ()
        {
            ...
            bar5.Set('chart.colors', ['#FFCC66']); 
            bar5.Set('chart.tooltips', ['Despesas Variaveis de Venda em  Janeiro em R$: ' + jan, 'Despesas Variaveis de Venda em  Fevereiro em R$: ' + fev, 'Despesas Variaveis de Venda em  Março em R$: ' + mar, 'Despesas Variaveis de Venda em  Abril em R$: ' + abr, 'Despesas Variaveis de Venda em Maio em R$: ' + mai, 'Despesas Variaveis de Venda em Junho em R$: ' + jun, 'Despesas Variaveis de Venda em Julho em R$: ' + jul, 'Despesas Variaveis de Venda em Agosto em R$: ' + ago, 'Despesas Variaveis de Venda em Setembro em R$: ' + set, 'Despesas Variaveis de Venda em Outubro em R$: ' + out, 'Despesas Variaveis de Venda em Novembro em R$: ' + nov, 'Despesas Variaveis de Venda em Dezembro em R$: ' + dez]);
      ...
      <div id="page-wrapper">
            <div class="row">
                    ...
                    <div class="panel-warning">
                        ...
                        <center>
                        <h4>
                          Despesas Variaveis de Venda Acumulado no Ano de <?php echo $ano?>: R$=<?php echo $total?>
                            </h4>
                            </center>
                        </div>
            <!-- /.row -->
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="float:left;">
                  ...
                  <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Despesas Variaveis de Venda Janeiro:<font color=#FF9900><?php echo $me[1]; ?> </font><br> 
                  <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Despesas Variaveis de Venda Fevereiro:<font color=#FF9900><?php echo $me[2]; ?> </font><br> 
                 <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Variaveis de Venda Março:<font color=#FF9900><?php echo $me[3]; ?></font><br> 
                 <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Variaveis de Venda  Abril:<font color=#FF9900><?php echo $me[4]; ?></font><br> 
                 <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Variaveis de Venda  Maio:<font color=#FF9900><?php echo $me[5]; ?></font><br> 
                 <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Variaveis de Venda Junho:<font color=#FF9900><?php echo $me[6]; ?></font><br> 
                   </div>
                 ...
                 <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>Despesas Variaveis de Venda Julho:<font color=#FF9900><?php echo $me[7]; ?></font><br>  
                 <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>Despesas Variaveis de Venda Agosto:<font color=#FF9900><?php echo $me[8]; ?></font><br> 
                 <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Despesas Variaveis de Venda Setembro:<font color=#FF9900><?php echo $me[9]; ?></font><br> 
                <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Despesas Variaveis de Venda Outubro:<font color=#FF9900><?php echo $me[10]; ?></font><br> 
                 <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Despesas Variaveis de Venda Novembro:<font color=#FF9900><?php echo $me[11]; ?></font><br> 
                <img src="css/img/perigo.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>  Despesas Variaveis de Venda Dezembro:<font color=#FF9900><?php echo $me[12]; ?></font><br> 
