...
<?php
     ...
     $ano=$_GET['ano1'];
        ...
        $sql15= "SELECT  valorpadrao,valoralcancado FROM indicadores  WHERE mesano ='$ano-0$i' and descricao='Custos Fixos'";
       
       }
       else{
      
        $sql15= "SELECT  valorpadrao,valoralcancado FROM indicadores  WHERE mesano ='$ano-$i' and descricao='Custos Fixos'"; 
      ...
      <div id="page-wrapper">
            <div class="row">
                    ...
                    <div class="panel-yellow">
                        ...
                        <center>
                        <h4>
                          Gráfico Indicadores Custo Fixo de Desempenho no Ano de <?php echo $ano?>
                            </h4>
                            </center>
                        </div>
            <!-- /.row -->
