        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <li class="dropdown">
                    ...
                    <form action="resultadosimulacaodreano.php" method="GET">
                ...
                <span class="add-on" style="width: 150px;">Informe a Porcentagem&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								<input type="tex" name="porcentagem" required>
								<br>
								<br>
								<center>
