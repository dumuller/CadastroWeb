...
<head>
 ...
 <?php
  ...
  $sql= "SELECT  valor FROM dre WHERE mesano ='$ano-$i' and descricao='DESPESAS COMERCIAL'";
    ...
    window.onload = function ()
        {
            ...
            bar5.Set('chart.tooltips', ['Despesas Comerciais em  Janeiro em R$: ' + jan, 'Despesas Comerciais em  Fevereiro em R$: ' + fev, 'Despesas Comerciais em  Março em R$: ' + mar, 'Despesas Comerciais em  Abril em R$: ' + abr, 'Despesas Comerciais em Maio em R$: ' + mai, 'Despesas Comerciais  em Junho em R$: ' + jun, 'Despesas Comerciais em Julho em R$: ' + jul, 'Despesas Comerciais em Agosto em R$: ' + ago, 'Despesas Comerciais em Setembro em R$: ' + set, 'Despesas Comerciais em R$: ' + out, 'Despesas Comerciais em Novembro em R$: ' + nov, 'Despesas Comerciais em Dezembro em R$: ' + dez]);
      ...
      <div id="page-wrapper">
            <div class="row">
                    ...
                    <div class="panel-red">
                        ...
                        <center>
                        <h4>
                          Despesas Comerciais Acumulado no Ano de <?php echo $ano?>: R$=<?php echo $total?>
                            </h4>
                            </center>
                        </div>
            <!-- /.row -->
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="float:left;">
                  ...
                  <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Despesas Comerciais Janeiro:<font color=red><?php echo $me[1]; ?> </font><br> 
                  <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Despesas Comerciais Fevereiro:<font color=red><?php echo $me[2]; ?> </font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Comerciais Março:<font color=red><?php echo $me[3]; ?>&nbsp;&nbsp;</font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Comerciais  Abril:<font color=red><?php echo $me[4]; ?></font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Comerciais Maio:<font color=red><?php echo $me[5]; ?></font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Comerciais Junho:<font color=red><?php echo $me[6]; ?></font><br> 
                  </div>
                 ...
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>Despesas Comerciais Julho:<font color=red><?php echo $me[7]; ?></font><br>  
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>Despesas Comerciais Agosto:<font color=red><?php echo $me[8]; ?></font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Despesas Comerciais Setembro:<font color=red><?php echo $me[9]; ?></font><br> 
                <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Despesas Comerciais Outubro:<font color=red><?php echo $me[10]; ?></font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Despesas Comerciais  Novembro:<font color=red><?php echo $me[11]; ?></font><br> 
                <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>  Despesas Comerciais Dezembro:<font color=red><?php echo $me[12]; ?></font><br> 
