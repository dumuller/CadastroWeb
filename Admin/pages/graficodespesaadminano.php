...
<head>
 ...
 <?php
  ...
  $sql= "SELECT  valor FROM dre WHERE mesano ='$ano-$i' and descricao='DESPESAS ADMINISTRATIVAS'";
    ...
    window.onload = function ()
        {
            ...
            bar5.Set('chart.colors', ['#FF3300']); 
            bar5.Set('chart.tooltips', ['Despesas Administrativas em  Janeiro em R$: ' + jan, 'Despesas Administrativas em  Fevereiro em R$: ' + fev, 'Despesas Administrativas em  Março em R$: ' + mar, 'Despesas Administrativas em  Abril em R$: ' + abr, 'Despesas Administrativas em Maio em R$: ' + mai, 'Despesas Administrativas  em Junho em R$: ' + jun, 'Despesas Administrativas em Julho em R$: ' + jul, 'Despesas Administrativas em Agosto em R$: ' + ago, 'Despesas Administrativas em Setembro em R$: ' + set, 'Despesas Administrativas em R$: ' + out, 'Despesas Administrativas em Novembro em R$: ' + nov, 'Despesas Administrativas em Dezembro em R$: ' + dez]);
      ...
      <div id="page-wrapper">
            <div class="row">
                    ...
                    <div class="panel-red">
                        ...
                        <center>
                        <h4>
                          Despesas Administrativas Acumulado no Ano de <?php echo $ano?>: R$=<?php echo $total?>
                            </h4>
                            </center>
                        </div>
            <!-- /.row -->
     ...
     <form id="form1" name="form1" action="<?php $_SERVER['PHP_SELF']?>"" method="post">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="float:left;">
                  ...
                  <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Despesas Administrativas Janeiro:<font color=red><?php echo $me[1]; ?> </font><br> 
                  <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Despesas Administrativas Fevereiro:<font color=red><?php echo $me[2]; ?> </font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Administrativas Março:<font color=red><?php echo $me[3]; ?>&nbsp;&nbsp;</font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Administrativas Abril:<font color=red><?php echo $me[4]; ?></font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Administrativas Maio:<font color=red><?php echo $me[5]; ?></font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Despesas Administrativas Junho:<font color=red><?php echo $me[6]; ?></font><br> 
                  </div>
                 ...
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>Despesas Administrativas Julho:<font color=red><?php echo $me[7]; ?></font><br>  
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>Despesas Administrativas Agosto:<font color=red><?php echo $me[8]; ?></font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Despesas Administrativas Setembro:<font color=red><?php echo $me[9]; ?></font><br> 
                <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Despesas Administrativas Outubro:<font color=red><?php echo $me[10]; ?></font><br> 
                 <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Despesas Administrativas Novembro:<font color=red><?php echo $me[11]; ?></font><br> 
                <img src="css/img/red.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>  Despesas Administrativas Dezembro:<font color=red><?php echo $me[12]; ?></font><br> 
        </div>
                   <div>
