        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <center>
                        <h4>
                           Demonstrativo Resumido De Resultados no Ano de <?php echo $ano?>
                            </h4>
                            </center>
                        </div>
                            ...
                            <div class="dataTable_wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                     ...
                                     <tr class="info">
                                            ...
                                            <th>Ponto Equilibrio</th>
                                            <?php
                        
                                              for($cont=1;$cont<=12; $cont++){
                                             echo "    
                                            <td> $pontoequilibriofinanceiro[$cont]</td>";
                                            }
                                             ?>
                                           
                                            <th><font color=#0000CC><?php echo $totalpontoequilibriofinanceiro?></font></th>
