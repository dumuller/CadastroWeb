...
<head>
 ...
 <?php
      ...
      for ($i = 1; $i <= 12; $i++) {
		  if ($i<10){
      $sql= "SELECT  valor FROM dre WHERE mesano ='$ano-0$i' and descricao='DEVOLUCAO DE VENDAS'";
   }
   
      else{
  $sql= "SELECT  valor FROM dre WHERE mesano ='$ano-$i' and descricao='DEVOLUCAO DE VENDAS'";
    ...
    window.onload = function ()
        {
            ...
            bar5.Set('chart.colors', ['#FF6600']); 
            bar5.Set('chart.tooltips', ['Devolucao Vendas em  Janeiro em R$: ' + jan, 'Devolucao Vendas em  Fevereiro em R$: ' + fev, 'Devolucao Vendas em  Março em R$: ' + mar, 'Devolucao Vendas em  Abril em R$: ' + abr, 'Devolucao Vendas em Maio em R$: ' + mai, 'Devolucao Vendas em Junho em R$: ' + jun, 'Devolucao Vendas em Julho em R$: ' + jul, 'Devolucao Vendas em Agosto em R$: ' + ago, 'Devolucao Vendas em Setembro em R$: ' + set, 'Devolucao Vendas em Outubro em R$: ' + out, 'Devolucao Vendas em Novembro em R$: ' + nov, 'Devolucao Vendas em Dezembro em R$: ' + dez]);
      ...
      <div id="page-wrapper">
            <div class="row">
                    ...
                    <div class="panel panel-yellow ">
                        ...
                        <center>
                        <h4>
                           <b>Devolução Vendas Acumulado no Ano de <?php echo $ano?>: R$=<?php echo $total?></b>
                            </h4>
                            </center>
                        </div>
            <!-- /.row -->
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="float:left;">
                  ...
                  <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Devolução Vendas Janeiro:<font color=#FF6600><?php echo $me[1]; ?> </font><br> 
                  <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Devolução Vendas Fevereiro:<font color=#FF6600><?php echo $me[2]; ?> </font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Devolução Vendas Março:<font color=#FF6600><?php echo $me[3]; ?></font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Devolução Vendas  Abril:<font color=#FF6600><?php echo $me[4]; ?></font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Devolução Vendas  Maio:<font color=#FF6600><?php echo $me[5]; ?></font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Devolução Vendas Junho:<font color=#FF6600><?php echo $me[6]; ?></font><br> 
                  </div>
                  ...
                  <div style="float:left;">
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Devolução Vendas Julho:<font color=#FF6600><?php echo $me[7]; ?></font><br>  
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Devolução Vendas Agosto:<font color=#FF6600><?php echo $me[8]; ?></font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> RDevolução Vendas Setembro:<font color=#FF6600><?php echo $me[9]; ?></font><br> 
                <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Devolução Vendas Outubro:<font color=#FF6600><?php echo $me[10]; ?></font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Devolução Vendas Novembro:<font color=#FF6600><?php echo $me[11]; ?></font><br> 
                <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>  Devolução Vendas Dezembro:<font color=#FF6600><?php echo $me[12]; ?></font><br> 
