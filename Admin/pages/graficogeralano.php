        ...
        <div id="page-wrapper">
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <center>
                        <h4>
                           <b>Gráficos Demonstrativos Resumidos De Resultados no Ano de <?php echo $mes1?> <?php echo $ano?></b>
                            </h4>
                            </center>
                        </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <center>
                        <b>
                            Resultado Liquido Acumulado no Ano de <?php echo $ano?>: R$=<?php echo $total?>
                            </b>
                            </center>
                        </div>
                        <!-- /.panel-heading -->
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="float:left;">
                  ...
                  <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Resultado Liquido Janeiro:<font color=blue><?php echo $me[1]; ?> </font><br> 
                  <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Resultado Liquido Fevereiro:<font color=blue><?php echo $me[2]; ?> </font><br> 
                 <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Resultado Liquido Março:<font color=blue><?php echo $me[3]; ?></font><br> 
                 <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Resultado Liquido  Abril:<font color=blue><?php echo $me[4]; ?></font><br> 
                 <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Resultado Liquido  Maio:<font color=blue><?php echo $me[5]; ?></font><br> 
                 <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Resultado Liquido Junho:<font color=blue><?php echo $me[6]; ?></font><br> 
                  </div>
                  ...
                  <div style="float:left;">
                 <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Resultado Liquido Julho:<font color=blue><?php echo $me[7]; ?></font><br>  
                 <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Resultado Liquido Agosto:<font color=blue><?php echo $me[8]; ?></font><br> 
                 <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Resultado Liquido Setembro:<font color=blue><?php echo $me[9]; ?></font><br> 
                <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Resultado Liquido Outubro:<font color=blue><?php echo $me[10]; ?></font><br> 
                 <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b> Resultado Liquidoo Novembro:<font color=blue><?php echo $me[11]; ?></font><br> 
                <img src="css/img/azul.jpg" width="20" height="20" alt="Metas" title="Resultado"/> <b>  Resultado Liquido Dezembro:<font color=blue><?php echo $me[12]; ?></font><br> 
