...
<head>
 ...
 <?php
      ...
      for ($i = 1; $i <= 12; $i++) {
		  if ($i<10){
      $sql= "SELECT  valor FROM dre WHERE mesano ='$ano-0$i' and descricao='CUSTOS FIXOS'";
   }
   
      else{
  $sql= "SELECT  valor FROM dre WHERE mesano ='$ano-$i' and descricao='CUSTOS FIXOS'";
    ...
    window.onload = function ()
        {
            ...
            bar5.Set('chart.tooltips', ['Custos Fixos em  Janeiro em R$: ' + jan, 'Custos Fixos em  Fevereiro em R$: ' + fev, 'Custos Fixos em  Março em R$: ' + mar, 'Custos Fixos em  Abril em R$: ' + abr, 'Custos Fixos em Maio em R$: ' + mai, 'Custos Fixos em Junho em R$: ' + jun, 'Custos Fixos em Julho em R$: ' + jul, 'Custos Fixos em Agosto em R$: ' + ago, 'Custos Fixos em Setembro em R$: ' + set, 'Custos Fixos em Outubro em R$: ' + out, 'Custos Fixos em Novembro em R$: ' + nov, 'Custos Fixos em Dezembro em R$: ' + dez]);
      ...
      <div id="page-wrapper">
            <div class="row">
                    ...
                    <div class="panel panel-yellow ">
                        ...
                        <center>
                        <h4>
                           <b>Custos Fixos Acumulado no Ano de <?php echo $ano?>: R$=<?php echo $total?></b>
                            </h4>
                            </center>
                        </div>
            <!-- /.row -->
  ...
  <form id="form1" name="form1" action="<?php $_SERVER['PHP_SELF']?>"" method="post">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="float:left;">
                  ...
                  <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>Custos Fixos em  Janeiro:<font color=#FF9933><?php echo $me[1]; ?> </font><br> 
                  <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Custos Fixos em  Fevereiro:<font color=#FF9933><?php echo $me[2]; ?> </font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Custos Fixos em  Março:<font color=#FF9933><?php echo $me[3]; ?>&nbsp;&nbsp;</font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Custos Fixos em   Abril:<font color=#FF9933><?php echo $me[4]; ?></font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Custos Fixos em   Maio:<font color=#FF9933><?php echo $me[5]; ?></font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Custos Fixos em  Junho:<font color=#FF9933><?php echo $me[6]; ?></font><br> 
    </div>
                  ...
                  <div style="float:left;">  
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b> Custos Fixos em  Julho:<font color=#FF9933><?php echo $me[7]; ?></font><br>  
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b> Custos Fixos em  Agosto:<font color=#FF9933><?php echo $me[8]; ?></font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b> Custos Fixos em  Setembro:<font color=#FF9933><?php echo $me[9]; ?></font><br> 
                <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado">  <b> Custos Fixos em  Outubro:<font color=#FF9933><?php echo $me[10]; ?></font><br> 
                 <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b> Custos Fixos em  Novembro:<font color=#FF9933><?php echo $me[11]; ?></font><br> 
                <img src="css/img/laranja.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b>  Custos Fixos em  Dezembro:<font color=#FF9933><?php echo $me[12]; ?></font><br> 
