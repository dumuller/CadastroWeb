            ...
            <div class="row">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">DRE</div>
                                    <div>DRE Completa</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo "dreresumidaano.php?&ano1=$ano";?>">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">Indicadores</div>
                                    <div>Desempenho</div>
                                </div>
                            </div>
                        </div>
              ...
              <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <center>
                        <h4>
                            Demonstrativo De Resultados no Ano de <?php echo $ano?>
                            </h4>
                            </center>
                        </div>
