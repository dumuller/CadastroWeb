...
<head>
 ...
 <?php
  ...
  $sql= "SELECT  valor FROM dre WHERE mesano ='$ano-$i' and descricao='RECEITA BRUTA'";
    ...
    window.onload = function ()
        {
            ...
            bar5.Set('chart.colors', ['#00CC00']); 
            bar5.Set('chart.tooltips', ['Receita Bruta em  Janeiro em R$: ' + jan, 'Receita Bruta em  Fevereiro em R$: ' + fev, 'Receita Bruta em  Março em R$: ' + mar, 'Receita Bruta em  Abril em R$: ' + abr, 'Receita Bruta em Maio em R$: ' + mai, 'Receita Bruta em Junho em R$: ' + jun, 'Receita Bruta em Julho em R$: ' + jul, 'Receita Bruta em Agosto em R$: ' + ago, 'Receita Bruta em Setembro em R$: ' + set, 'Receita Bruta em Outubro em R$: ' + out, 'Receita Bruta em Novembro em R$: ' + nov, 'Receita Bruta em Dezembro em R$: ' + dez]);
      ...
      <div id="page-wrapper">
            <div class="row">
                    ...
                    <div class="panel-green">
                        ...
                        <center>
                        <h4>
                           <b>Receita Bruta Acumulado no Ano de <?php echo $ano?>: R$=<?php echo $total?></b>
                            </h4>
                            </center>
                        </div>
            <!-- /.row -->
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="float:left;">
                  ...
                  <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Receita Bruta Janeiro:<font color=#006633><?php echo $me[1]; ?> </font><br> 
                  <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b> Receita Bruta Fevereiro:<font color=#006633><?php echo $me[2]; ?> </font><br> 
                 <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Receita Bruta Março:<font color=#006633><?php echo $me[3]; ?>&nbsp;&nbsp;</font><br> 
                 <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Receita Bruta  Abril:<font color=#006633><?php echo $me[4]; ?></font><br> 
                 <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Receita Bruta  Maio:<font color=#006633><?php echo $me[5]; ?></font><br> 
                 <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"/>  <b>  Receita Bruta Junho:<font color=#006633><?php echo $me[6]; ?></font><br> 
                  </div>
                 ...
                 <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b> Receita Bruta Julho:<font color=#006633><?php echo $me[7]; ?></font><br>  
                 <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b> Receita Bruta Agosto:<font color=#006633><?php echo $me[8]; ?></font><br> 
                 <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b> Receita Bruta Setembro:<font color=#006633><?php echo $me[9]; ?></font><br> 
                <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado">  <b> Receita Bruta Outubro:<font color=#006633><?php echo $me[10]; ?></font><br> 
                 <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b> Receita Bruta Novembro:<font color=#006633><?php echo $me[11]; ?></font><br> 
                <img src="css/img/verde.jpg" width="20" height="20" alt="Metas" title="Resultado"> <b>  Receita Bruta Dezembro:<font color=#006633><?php echo $me[12]; ?></font><br> 
